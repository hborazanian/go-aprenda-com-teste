...
func TestAdiciona(t *testing.T) {
	t.Run("palavra nova", func(t *testing.T) {
		...
		erro := dicionario.Adiciona(palavra, definicao)

		comparaErro(t, erro, nil)
	...
	t.Run("palavra existente", func(t *testing.T) {
		...
		erro := dicionario.Adiciona(palavra, "teste novo")

		comparaErro(t, erro, ErrPalavraExistente)
		comparaDefinicao(t, dicionario, palavra, definicao)
	})
}
...
func TestUpdate(t *testing.T) {
	t.Run("palavra existente", func(t *testing.T) {
		...
		dicionario := Dicionario{palavra: definicao}
		erro := dicionario.Atualiza(palavra, novaDefinicao)
	...
	t.Run("palavra nova", func(t *testing.T) {
		...
		erro := dicionario.Atualiza(palavra, definicao)

		comparaErro(t, erro, ErrPalavraInexistente)
	})
}
...
func comparaDefinicao(t *testing.T, dicionario Dicionario, palavra, definicao string) {
	...
	resultado, erro := dicionario.Busca(palavra)

	if erro != nil {
		t.Fatal("deveria ter encontrado palavra adicionada:", erro)
	}
